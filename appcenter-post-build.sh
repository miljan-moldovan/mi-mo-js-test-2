...
then
  ...
  curl -X POST -H 'Content-type: application/json' --data "{\"text\": \"Available new build\", \"attachments\": [{\"color\": \"#36a64f\",\"title\": \"Mobile POS\",\"title_link\": \"https://betas.to/5k1zsCBG\",\"fields\": [{\"title\": \"Git Branch\",\"value\": \"$APPCENTER_BRANCH\",},{\"title\": \"Git Hash\",\"value\": \"$GIT_HASH\"},{\"title\": \"Git Commit\",\"value\": \"$GIT_COMMIT_MESSAGE\"},{\"title\": \"Build ID\",\"value\": \"$APPCENTER_BUILD_ID\"}],\"actions\": [{\"type\": \"button\",\"text\": \"Install\",\"url\": \"https://betas.to/5k1zsCBG\"}]}]}" https://hooks.slack.com/services/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 #su_mobileapp
    
  LAST_COMMITS=`git log -n 10 --pretty=oneline --abbrev-commit  | sed -E ':a;N;$!ba;s/\r{0,1}\n/\\n/g'` #| sed "s/'/\"/g"
  curl -X POST -H 'Content-type: application/json' --data "{\"text\": \"Available new build\", \"attachments\": [{\"text\": \"$LAST_COMMITS\",\"color\": \"#36a64f\",\"title\": \"Mobile POS\",\"title_link\": \"https://betas.to/5k1zsCBG\",\"fields\": [{\"title\": \"Git Branch\",\"value\": \"$APPCENTER_BRANCH\",},{\"title\": \"Git Hash\",\"value\": \"$GIT_HASH\"},{\"title\": \"Git Commit\",\"value\": \"$GIT_COMMIT_MESSAGE\"},{\"title\": \"Build ID\",\"value\": \"$APPCENTER_BUILD_ID\"}],\"actions\": [{\"type\": \"button\",\"text\": \"Install\",\"url\": \"https://betas.to/5k1zsCBG\"}]}]}" https://hooks.slack.com/services/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 #mobile_development
