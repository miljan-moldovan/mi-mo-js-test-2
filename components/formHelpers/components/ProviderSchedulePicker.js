...
class ProviderSchedulePicker extends React.Component {
  componentDidMount() {
    ...
    scheduleActions.getEmployeeScheduleForDate(get(employee, 'id', null), moment(date).format('YYYY-MM-DD'));
  }
  ...
  componentWillReceiveProps(newProps) {
    ...
    if (date !== newProps.date || employee.id !== get(newProps.employee, 'id')) {
      scheduleActions.getEmployeeScheduleForDate(get(newProps.employee, 'id', null), moment(newProps.date).format('YYYY-MM-DD'));
    }
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(ProviderSchedulePicker);
