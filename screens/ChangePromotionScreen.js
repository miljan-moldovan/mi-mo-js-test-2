...
const promotions = require('./../mockData/providers.json');
...
export default class ChangePromotionScreen extends React.Component {
  ...
  componentWillMount() {
    ...
    this.props.navigation.setParams({ onChangeText: searchText => this._filterServices(searchText) });
  }
