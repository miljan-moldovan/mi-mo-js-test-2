    ...
    return (
      <View style={styles.container}>
        <KeyboardAvoidingView
           ...
           behavior="padding"
         >
          <Text style={{marginTop: 60, marginBottom: 20, fontSize: 22, fontWeight: '600'}}>API Settings</Text>
          <Item>
            <Label>API URL</Label>
            <Input autoCorrect={false} blurOnSubmit={true} autoCapitalize="none" onChangeText={this._handleURLChange} value={this.state.apiURL} />
          </Item>
          <Item>
            <Label>Store</Label>
            <Input autoCorrect={false} blurOnSubmit={true} autoCapitalize="none" onChangeText={this._handleStoreChange} value={this.state.store} />
          </Item>
