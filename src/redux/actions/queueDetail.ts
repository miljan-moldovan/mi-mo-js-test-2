...
export const GET_APPOINTMENT_SUCCESS =
  'appointmentDetails/GET_APPOINTMENT_SUCCESS';
export const GET_APPOINTMENT_FAILED =
  'appointmentDetails/GET_APPOINTMENT_FAILED';
export const GET_SERVICE_CHECK = 'appointmentDetails/GET_SERVICE_CHECK';
export const GET_SERVICE_CHECK_SUCCESS =
  'appointmentDetails/GET_SERVICE_CHECK_SUCCESS';
export const GET_SERVICE_CHECK_FAILED =
  'appointmentDetails/GET_SERVICE_CHECK_FAILED';
export const UPDATE_APPOINTMENT = 'appointmentDetails/UPDATE_APPOINTMENT';
export const UPDATE_APPOINTMENT_SUCCESS =
  'appointmentDetails/UPDATE_APPOINTMENT_SUCCESS';
