...
export const GET_SERVICE_PROMOTIONS_SUCCESS =
  'promotions/GET_SERVICE_PROMOTIONS_SUCCESS';
export const GET_SERVICE_PROMOTIONS_FAILED =
  'promotions/GET_SERVICE_PROMOTIONS_FAILED';

export const GET_PRODUCT_PROMOTIONS = 'promotions/GET_PRODUCT_PROMOTIONS';
export const GET_PRODUCT_PROMOTIONS_SUCCESS =
  'promotions/GET_PRODUCT_PROMOTIONS_SUCCESS';
