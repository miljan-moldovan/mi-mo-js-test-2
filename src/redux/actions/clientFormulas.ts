...
export interface ClientFormulasActions {
  setFormulas: (formulas: any) => any;
  setFilteredFormulas: (filtered: any) => any;
  selectProvider: (provider: any) => any;
  setOnEditionFormula: (onEditionFormula: any) => any;
  getClientFormulas: (clientId: number) => any;
  postClientFormulas: (clientId: number, formula: any) => any;
  deleteClientFormulas: (clientId: number, formulaId: number) => any;
  undeleteClientFormulas: (clientId: number, formulaId: number) => any;
  putClientFormulas: (clientId: number, formula: any) => any;
  setClientFormulaUpdateForm: (formula: any) => any;
  setClientFormulaNewForm: (clientId: number, formula: any) => any;
  purgeClientFormulaNewForm: (clientId: number, formula: any) => any;
  purgeClientFormulaUpdateForm: (formula: any) => any;
}
