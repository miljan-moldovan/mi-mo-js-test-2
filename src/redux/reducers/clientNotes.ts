...
import { Maybe, PureProvider, Note } from '@/models';

const initialState: ClientNotesReducer = {
  notes: [],
  filtered: [],
...
export interface ClientNotesReducer {
  notes: Note[];
  filtered: Note[];
...
export default function clientNotesReducer(state: ClientNotesReducer = initialState, action): ClientNotesReducer {
