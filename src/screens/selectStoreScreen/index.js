  ...
  renderListItem = ({item}) => {
    ...
    return (
      <SalonTouchableOpacity onPress={() => this.handleSelectStore (item.id)}>
        {!selectedStore && <Text style={styles.listItem}>{item.name}</Text>}
        {selectedStore &&
          <View style={styles.selectedStoreWrapper}>
            <Text style={[styles.selectedItem]}>{item.name}</Text>
            <FontAwesome style={styles.selectedItemIcon}>
              {Icons.checkCircle}
            </FontAwesome>
          </View>}
    ...
    <View style={styles.contentWrapper}>
      ...
      <View style={styles.listWrapper}>
        <FlatList
          ...
          ListFooterComponent={() => <View style={styles.listColumnWrapper} />}
