...
import multiProviderUri
  from '../../../../../assets/svg/multi-provider-icon.svg';
...
>>>>>>> fa3b13f66e35da52e64b3e8e7f38f0f35bdacc71:src/components/SalonCalendar/components/newCalendar/card/index.tsx
  ...
  render () {
    ...
    let activeClientTextColor = badgeData.isCashedOut
      ? '#1DA314'
      : clientTextColor;
    activeClientTextColor = badgeData.isNoShow
      ? '#D0021B'
      : activeClientTextColor;
